...
def test_query_suggestions_standalone():
    """Standalone test for query suggestions endpoint"""
    API_BASE_URL = "http://localhost:8000"
    QUERY_SUGGESTIONS_ENDPOINT = f"{API_BASE_URL}/query-suggestions"
    
    print("Testing Query Suggestions Endpoint")
    print("=" * 50)
...
if __name__ == "__main__":
    test_query_suggestions_standalone()
# import requests
# import json
# import uuid
# import time
